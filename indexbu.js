...
function _load() {
  ...
  return regeneratorRuntime.async(function _load$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        ...
        context$1$0.next = 5;
        return regeneratorRuntime.awrap((0, _fishing.toPromise)(unzip));

      case 5:
        csv = context$1$0.sent.toString();
        context$1$0.next = 8;
        return regeneratorRuntime.awrap((0, _es6Promisify2['default'])(_csvParse2['default'])(csv, {}));
...
function load() {
  return regeneratorRuntime.async(function load$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      ...
      case 4:
        context$1$0.next = 6;
        return regeneratorRuntime.awrap(_load());
...
function lastPrice() {
  var prices, url;
  return regeneratorRuntime.async(function lastPrice$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        prices = null;
        ...
        context$1$0.next = 6;
        return regeneratorRuntime.awrap(_requestPromiseJson2['default'].get(url));
...
function btcToUSD(btc, dateTime) {
  ...
  return regeneratorRuntime.async(function btcToUSD$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        ...
        context$1$0.next = 3;
        return regeneratorRuntime.awrap(lastPrice());
